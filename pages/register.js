  ...
  <div class="p-10 xs:p-0 mx-auto md:w-full md:max-w-md">
    ...
    <div class="bg-white shadow-2xl w-full rounded-3xl divide-y divide-gray-200">
      ...
      <div>
        ...
        <button type="button" class="transition duration-200 bg-oxford hover:bg-venetian focus:shadow-xl focus:ring-4 focus:ring-marigold focus:ring-opacity-0 text-white w-full py-2.5 rounded-lg text-sm shadow-sm hover:shadow-md font-semibold text-center inline-block">
